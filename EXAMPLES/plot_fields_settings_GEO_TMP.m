...
contour_mod = 2;        % [   1]  NUMBER OF COLOR INTERVALS PER CONTOR
contour_mod_label = 10;  % [   5]  NUMBER OF COLOR INTERVALS PER CONTOUR
...
colorbar_name='LinearL'; % ['parula'] COLORBAR COLOR SCALE NAME
...
data_size = 50.0;       % [25.0]  SIZE OF OVERLAY DATA POINTS
data_sitelabel = 'y';   % [ 'n']  LABEL SITES?
data_sitecolor = 'w';   % [ 'k']  SITE MARKER COLOR
data_sitelineth = 1.5;  % [ 1.0]  SITE MARKER LINE THICKNESS
...
plot_lon_origin = 00; % [-180]  STARTING LONGITUDE FOR X-AXIS
plot_lon_delta = 90;    % [  90]  INCREMENT OF LONGITUDE ON X-AXIS
plot_title = 'Subsurface [O_{2}] at 8% atmospheric O_{2}';        % [  '']  OPTIONAL REPLACEMENT TITLE
