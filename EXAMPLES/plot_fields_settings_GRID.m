...
data_size = 35.0;       % [25.0]  SIZE OF OVERLAY DATA POINTS
data_sitelabel = 'y';   % [ 'n']  LABEL SITES?
data_sitecolor = 'r';   % [ 'k']  SITE MARKER COLOR
data_sitelineth = 1.0;  % [ 1.0]  SITE MARKER LINE THICKNESS
data_fontsz = 9;        % [   8]  LABEL FONT SIZE
...
plot_lon_origin = -0; % [-180]  STARTING LONGITUDE FOR X-AXIS
