...
plot_psi = 'y';         % [  '']  PLOT Barotropic streamfunction 
plot_opsi = '';         % [  '']  PLOT STREAMFUNCTION [''; 'g', 'a'; 'p']
plot_opsi_calc = 'n';   % [ 'n']  CALCULATE OPSI USING MASK?
plot_opsi_min = -60;    % [ -20]  MINIMUM STREAMFUNCTION VALUE
plot_opsi_max = +60;    % [ +20]  MAXIMUM STREAMFUNCTION VALUE
...
plot_title = 'PSI';        % [  '']  OPTIONAL REPLACEMENT TITLE
