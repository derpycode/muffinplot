...
contour_zero = 'n';     % [ 'y']  PLOT ZERO CONTOUR
contour_file = '';      % [  '']  OPTIONAL EXTERNAL PLOTTING SCALE
colorbar_name='anom'; % ['plasma'] COLORBAR COLOR SCALE NAME
colorbar_inv = 'y';     % [ 'n']  INVERT COLORBAR
...
plot_title = 'Overlying carbonate chemistry - dCO3_cal';        % [  '']  OPTIONAL REPLACEMENT TITLE
