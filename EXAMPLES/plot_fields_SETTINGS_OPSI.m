...
data_only = 'y';        % [ 'n']  PLOT ONLY DATA (no model values)?
...
plot_opsi = 'g';         % [  '']  PLOT STREAMFUNCTION [''; 'g', 'a'; 'p']
plot_opsi_calc = 'y';   % [ 'n']  CALCULATE OPSI USING MASK?
plot_opsi_min = -40;    % [ -20]  MINIMUM STREAMFUNCTION VALUE
plot_opsi_max = +40;    % [ +20]  MAXIMUM STREAMFUNCTION VALUE
plot_opsi_dminor = 4;   % [   2]  MINOR STREAMFUNCTION CONTOUR INCREMENT
