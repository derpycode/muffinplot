...
% temp
plot_fields_biogem_3d_k(DUM_EXP,'','ocn_temp','',DUM_T,-1,16,'',1.0,0.0,40.0,40,'','plot_fields_settings_TEMP',[DUM_EXP '.SST']);
% PSI
plot_fields_biogem_2d(DUM_EXP,'','atm_temp','',DUM_T,-1,16,'',1.0,0.0,30.0,30,'','plot_fields_settings_PSI',[DUM_EXP '.PSI']);
%%%% PSI (+ temp)
%%%plot_fields_biogem_2d(DUM_EXP,'','ocn_sur_temp','',DUM_T,-1,16,'',1.0,0.0,40.0,40,'','plot_fields_settings_PSI_temp',[DUM_EXP '.PSI_temp']);
% OPSI
...
%%%% wind stress
%%%plot_fields_biogem_2d(DUM_EXP,'','ocn_sur_temp','',9999.5,-1,16,'',1.0,0.0,30.0,30,'','plot_fields_settings_tau',[DUM_EXP '.tau']);
% currents (+ speed)
plot_fields_biogem_3d_k(DUM_EXP,'','ocn_temp','',DUM_T,-1,16,'',1.0,0.0,0.1,20,'','plot_fields_settings_UV',[DUM_EXP '.uv']);
% currents (+ temp)
plot_fields_biogem_3d_k(DUM_EXP,'','ocn_temp','',DUM_T,-1,16,'',1.0,0.0,40.0,40,'','plot_fields_settings_UV_temp',[DUM_EXP '.uv_temp']);
%
% *********************************************************************** %
