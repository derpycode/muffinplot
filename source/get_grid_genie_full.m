function [loc_grid_sv, loc_grid_s, loc_grid_dz, loc_grid_dza] = get_grid_genie_full(DUM_NI,DUM_NJ,DUM_NK)
% GET_GRID_GENIE_FULL
%
%   *********************************************************
%   *** Generate GENIE grid                               ***
...
%
  ...
  for k=1:dum_n_k,
     if loc_grid_ez0 > 0.0
        ...
        if k < dum_n_k
           loc_grid_dza(dum_n_k-k) = loc_grid_tv5 - loc_grid_tv4;
        else
           loc_grid_dza(k) = 0.0;
        end
        loc_grid_tv4 = loc_grid_tv5;
        loc_grid_tv1 = loc_grid_tv1 + loc_grid_dz(dum_n_k-k+1);
     end
  end
  %
  for k=1:dum_n_k,
